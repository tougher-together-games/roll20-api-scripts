...
Link to [Gnome Font](https://github.com/tougher-together-games/default-game-assets/blob/main/fonts/rpg-katakana.zip).

![RPG Katakana alphabet character map](https://raw.githubusercontent.com/tougher-together-games/default-game-assets/refs/heads/main/fonts/images/rpg-katakana-font-charmap.png "img_center")

<div style="display: none;" id="easySpeakWords">
beste, konntest, letzir, spielte, schwanza, gleichen, fur, jedemahtey, mochtestihr, verbesserung, genaulich, forschunkel, unvollkommheit, gedankenweis, prufelheit
</div>