...
Link to [Espruar Font](https://github.com/tougher-together-games/default-game-assets/blob/main/fonts/olde-espruar.zip).

![Espruar alphabet character map](https://raw.githubusercontent.com/tougher-together-games/default-game-assets/refs/heads/main/fonts/images/olde-espruar-font-charmap.png "img_center")

<div style="display: none;" id="easySpeakWords">
usawna, nealan, shgun, faulsa, meyso, hungrr, belnapkeen, quayla, nickhaf, z'ress, veldrin, ssussun, darkael, tradeth, whsperrik
</div>